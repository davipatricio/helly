...
class SelectMenuInteraction extends BaseStructure {
  /** Raw {@link SelectMenuInteraction} data */
  ...
  /** The selected options for this interaction */
  get values() {
  ...
  /** @private */
  parseData(data: APIMessageComponentSelectMenuInteraction, args: Partial<SelectMenuInteraction> = {}) {
